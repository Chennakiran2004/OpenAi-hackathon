...
import { HiTruck, HiCurrencyDollar, HiLightningBolt, HiInformationCircle } from 'react-icons/hi';
...
export default function OptimizeForm() {
    ...
    const districtOptions: SelectOption[] = districts.map(d => ({ value: d.id, label: d.name }));
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <Card variant="glass" className="animate-slide-up">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <SearchableSelect
                                ...
                                placeholder={districtsLoading ? 'Loading districts...' : 'Select destination district'}
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-3 gap-3">
                                    {[
                                        { value: 'road', label: 'Road Only', icon: <HiTruck className="w-8 h-8 mx-auto" /> },
                                        { value: 'rail', label: 'Rail Only', icon: <RiTrainFill className="w-8 h-8 mx-auto" /> },
                                        {
                                        ...
                                        <button
                                            ...
                                            style={{
                                                border: transportMode === mode.value ? '2px solid green' : '2px solid #d1d5db',

                                            }}
                                            className={`
                      p-4 rounded-lg border-2 transition-all duration-250
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                        <Card variant="glass" className="text-center p-6">
                            ...
                            <div className="text-emerald-400 font-semibold text-lg">Optimized Pricing</div>
                        </Card>
                        <Card variant="glass" className="text-center p-6">
                            <div className="flex justify-center mb-4">
                            ...
                            <div className="text-slate-400 text-sm mb-1">Fastest Delivery</div>
                            <div className="text-blue-400 font-semibold text-lg">Minimal Transit Time</div>
                        </Card>
                        <Card variant="glass" className="text-center p-6">
                            <div className="flex justify-center mb-4">
                            ...
                            <div className="text-green-400 font-semibold text-lg">Eco-Friendly Routes</div>
                        </Card>
                    </div>
                </div>
            </div>
