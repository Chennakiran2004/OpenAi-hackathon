        ...
        <div className="p-8">
          ...
          >
            ...
            <p className="text-gray-600 font-medium flex items-center gap-1.5">
              <GrLocation className="w-4 h-4 text-brand-primary" />
              <span>{user?.profile?.state_name || "India"}</span>
            </p>
          </div>
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <Card
                  variant="elevated"
                  className="text-center group hover:border-brand-primary transition-all duration-300"
                >
                  <div className="text-gray-500 text-sm font-semibold mb-2 uppercase tracking-wider">
                    Total Queries
                  </div>
                ...
                <Card
                  variant="elevated"
                  className="text-center group hover:border-green-400 transition-all duration-300"
                >
                  <div className="text-gray-500 text-sm font-semibold mb-2 uppercase tracking-wider">
                    Money Saved
                  </div>
